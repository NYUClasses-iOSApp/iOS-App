...
class MenuBar: NSObject, MenuViewControllerDelegate {
    
    let barWidth:CGFloat = 200.0
    let sideBarTableViewTopInset:CGFloat = 73.0
    let sideBarContainerView:UIView = UIView()
    let sideBarTableViewController:MenuViewController = MenuViewController()
